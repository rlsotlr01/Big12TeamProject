...
if __name__ == '__main__':
    ...
    parser.add_argument('--policy_network_name') # 이 값 꼭 넣어줘야 함. 그래야 신경망이 저장됨
    parser.add_argument('--reuse_models', action='store_true') # # True : 신경망 불러오기, False : 신경망 새로
    parser.add_argument('--learning', action='store_true') # True : 학습. False : 시뮬레이션
    parser.add_argument('--start_date', default='20110401') # 시작일 (무조건 넣어주기)
    parser.add_argument('--end_date', default='20200631') # 종료일 (무조건 넣어주기)
